...
<div class="contentBigBox">
    <div id="headerNav" class="active">
        <h1>
            <img src="/images/logo.png" style="width: 40px;margin-top: 0px;">
            <span style="display: inline-block;vertical-align: middle;font-size: 26px;font-family: '时尚中黑简体';line-height: 58px;color: white;">在线会商平台</span>
        </h1>
        <ul id="nav">
            <li>
                <p>我的好友</p>
